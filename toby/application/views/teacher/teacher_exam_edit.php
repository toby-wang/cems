...
<<<<<<< HEAD
      ...
      <form class="form-horizontal" role="form" style="margin-top:50px;">
        <div class="form-group">
          ...
          <div class="col-sm-10">
              <input type="text" class="form-control" id="firstname" placeholder="15-3班">
          </div>
        </div>
        <div class="form-group">
           <label for="lastname" class="col-sm-2 control-label">考试内容</label>
           <div class="col-sm-10">
             <input type="text" class="form-control" id="lastname" placeholder="Java">
           </div>
        </div>
=======
