            ...
            <ul class="nav navbar-nav side-nav" id="sidebar">
              ...
              <li class="navigation" id="navigation">
                ...
                <ul class="menu">
                  ...
                  <li class="active">
                    <a href="admin-intro.html"  target="menuFrame">
                  ...
                  <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                      <li>
                        <a href="admin-teacher-add.html" target="menuFrame">
                          <i class="fa fa-caret-right"></i> 添加教师
                        </a>
                      </li>
                      <li>
                        <a href="admin-pwd-change.html" target="menuFrame">
                          <i class="fa fa-caret-right"></i> 修改密码
                        </a>
                      </li>
                      <li>
                        <a href="admin-teacher-delete.html" target="menuFrame">
                          <i class="fa fa-caret-right"></i> 删除教师
                        </a>
                      </li>
                      <li>
                        <a href="admin-teacher-all.html" target="menuFrame">
                  ...
                  <li class="dropdown">
                    <a href="admin-exam-deal.html" target="menuFrame" class="dropdown-toggle" data-toggle="dropdown">
                  ...
                  <li>
                    <a href="admin-system-set.html" target="menuFrame">
...
{% block content %}
 ...
 <div id="page_content" style="margin-top: 10px; margin-bottom: 10px;">
          <iframe id="menuFrame" name="menuFrame" src="admin-intro.html" scrolling="auto" allowtransparency="yes" style="width:100%;height:600px;float: left;">
             </iframe>
 </div>
        </div>
{% endblock %}
